...
if (!(update_info.statusCode >= 200 && update_info.statusCode < 300)){update_info = {
  ...
  "tiku_version": 20230807,
  "tiku_link": "https://gitcode.net/m0_64980826/songge_tiku/-/raw/master/tiku_json_20230807.txt",
  "tiku_link2": "https://raw.kgithub.com/OuO-dodo/tiku/master/tiku_json_20230807.txt",
...
function xxqg(userinfo) {
 ...
 // fInfo("vip:" + vip)
 //fInfo("等待首页---我的");
 if(text("我的").findOne(7000)) text("我的").findOne(5000).click();
 else{
  var qg_guanbi_thread = qg_guanbi();
